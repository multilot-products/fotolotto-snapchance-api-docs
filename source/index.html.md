...
r = requests.post('https://api-stg3.snapchance.no/deactivation', headers = headers)
...
try {
    $response = $client->request('POST','https://api-stg3.snapchance.no/deactivation', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/deactivation");
...
func main() {
    ...
    req, err := http.NewRequest("POST", "https://api-stg3.snapchance.no/deactivation", data)
    req.Header = headers
...
r = requests.put('https://api-stg3.snapchance.no/loss_limits', headers = headers)
...
try {
    $response = $client->request('PUT','https://api-stg3.snapchance.no/loss_limits', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/loss_limits");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("PUT", "https://api-stg3.snapchance.no/loss_limits", data)
    req.Header = headers
...
r = requests.patch('https://api-stg3.snapchance.no/onboard', headers = headers)
...
try {
    $response = $client->request('PATCH','https://api-stg3.snapchance.no/onboard', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/onboard");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("PATCH", "https://api-stg3.snapchance.no/onboard", data)
    req.Header = headers
...
r = requests.patch('https://api-stg3.snapchance.no/profile', headers = headers)
...
try {
    $response = $client->request('PATCH','https://api-stg3.snapchance.no/profile', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/profile");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("PATCH");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("PATCH", "https://api-stg3.snapchance.no/profile", data)
    req.Header = headers
...
r = requests.get('https://api-stg3.snapchance.no/profile', headers = headers)
...
try {
    $response = $client->request('GET','https://api-stg3.snapchance.no/profile', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "https://api-stg3.snapchance.no/profile", data)
    req.Header = headers
...
r = requests.post('https://api-stg3.snapchance.no/suspension', headers = headers)
...
try {
    $response = $client->request('POST','https://api-stg3.snapchance.no/suspension', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/suspension");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "https://api-stg3.snapchance.no/suspension", data)
    req.Header = headers
...
r = requests.get('https://api-stg3.snapchance.no/player/drawings', headers = headers)
...
try {
    $response = $client->request('GET','https://api-stg3.snapchance.no/player/drawings', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/player/drawings");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "https://api-stg3.snapchance.no/player/drawings", data)
    req.Header = headers
...
r = requests.get('https://api-stg3.snapchance.no/player/drawings/{id}', headers = headers)
...
try {
    $response = $client->request('GET','https://api-stg3.snapchance.no/player/drawings/{id}', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/player/drawings/{id}");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "https://api-stg3.snapchance.no/player/drawings/{id}", data)
    req.Header = headers
...
r = requests.post('https://api-stg3.snapchance.no/subscription', headers = headers)
...
try {
    $response = $client->request('POST','https://api-stg3.snapchance.no/subscription', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/subscription");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "https://api-stg3.snapchance.no/subscription", data)
    req.Header = headers
...
r = requests.patch('https://api-stg3.snapchance.no/subscription', headers = headers)
...
try {
    $response = $client->request('PATCH','https://api-stg3.snapchance.no/subscription', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("PATCH", "https://api-stg3.snapchance.no/subscription", data)
    req.Header = headers
...
r = requests.get('https://api-stg3.snapchance.no/subscription', headers = headers)
...
try {
    $response = $client->request('GET','https://api-stg3.snapchance.no/subscription', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "https://api-stg3.snapchance.no/subscription", data)
    req.Header = headers
...
r = requests.post('https://api-stg3.snapchance.no/subscription/cancellation', headers = headers)
...
try {
    $response = $client->request('POST','https://api-stg3.snapchance.no/subscription/cancellation', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/subscription/cancellation");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "https://api-stg3.snapchance.no/subscription/cancellation", data)
    req.Header = headers
...
r = requests.get('https://api-stg3.snapchance.no/subscription/entries', headers = headers)
...
try {
    $response = $client->request('GET','https://api-stg3.snapchance.no/subscription/entries', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/subscription/entries");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "https://api-stg3.snapchance.no/subscription/entries", data)
    req.Header = headers
...
r = requests.post('https://api-stg3.snapchance.no/wallet/deposits', headers = headers)
...
try {
    $response = $client->request('POST','https://api-stg3.snapchance.no/wallet/deposits', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/wallet/deposits");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "https://api-stg3.snapchance.no/wallet/deposits", data)
    req.Header = headers
...
r = requests.post('https://api-stg3.snapchance.no/wallet/withdrawals', headers = headers)
...
try {
    $response = $client->request('POST','https://api-stg3.snapchance.no/wallet/withdrawals', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/wallet/withdrawals");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "https://api-stg3.snapchance.no/wallet/withdrawals", data)
    req.Header = headers
...
r = requests.get('https://api-stg3.snapchance.no/wallet/balance', headers = headers)
...
try {
    $response = $client->request('GET','https://api-stg3.snapchance.no/wallet/balance', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/wallet/balance");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "https://api-stg3.snapchance.no/wallet/balance", data)
    req.Header = headers
...
r = requests.get('https://api-stg3.snapchance.no/wallet/transactions', headers = headers)
...
try {
    $response = $client->request('GET','https://api-stg3.snapchance.no/wallet/transactions', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/wallet/transactions");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "https://api-stg3.snapchance.no/wallet/transactions", data)
    req.Header = headers
...
```json
{
  "transactions": [
    ...
    },
    {
      ...
      "entry": {
        ...
        "tickets": [
          ...
          {
            "id": 4815329,
            "serial_number": "18627EB7-E76B-42D8-AC55-7979DFBEC4C6",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
    ...
    },
    {
      "type": "award",
      "amount": "30.00",
      "created_at": "2021-04-09T22:09:06.607Z",
      "status": "completed",
      "balance": "2050.00",
      "currency": "NOK",
      "entry": {
    ...
    },
    {
      "type": "award",
      "amount": "40.00",
      "created_at": "2021-04-09T22:09:06.595Z",
      "status": "completed",
      "balance": "2020.00",
      "currency": "NOK",
      "entry": {
        "id": 6581,
        "tickets_count": 5,
        "created_at": "2021-04-08T13:09:09.044Z",
        "entry_type": null,
        "is_revealed": true,
        "drawing": {
          "id": 2102,
          ...
          "headline": "Lottery for testing  purpose",
          "description": "",
          "ends_at": "2021-04-08T13:38:00.000Z",
          "tickets_count": 1000,
          "ticket_price": "25.00",
          "currency": "NOK",
          "cover_url": null,
        ...
        "photo": {
          "id": 2317,
          "url": "https://res.cloudinary.com/dw6cjlb5l/image/upload/v1617887348/cexdpbwigarg24jmyp8o.jpg",
          "thumbnail_url": "https://res.cloudinary.com/dw6cjlb5l/image/upload/c_fill,g_face,h_200,w_200/v1617887348/cexdpbwigarg24jmyp8o.jpg",
          "is_default": false,
          "is_played": true,
          "is_visible": true
        },
        "tickets": [
          {
            "id": 4816323,
            "serial_number": "2CE94B02-1753-432A-BFC9-C2F11C869378",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
          ...
          {
            "id": 4816324,
            "serial_number": "63B510D7-C8F1-4F76-A537-B8F02F03432D",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
          ...
          {
            "id": 4816327,
            "serial_number": "78A1A6E0-D86F-42C6-8835-AD1E7BCB18FF",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
          ...
          {
            "id": 4816326,
            "serial_number": "58325A49-C503-45B9-B942-D5647020D012",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
          ...
          {
            "id": 4816325,
            "serial_number": "A672E17A-C452-4A7C-8448-DCD9A9595EA4",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
    ...
    },
    {
      "type": "award",
      "amount": "30.00",
      "created_at": "2021-04-09T22:09:06.583Z",
      "status": "completed",
      "balance": "1980.00",
      "currency": "NOK",
      "entry": {
    ...
    },
    {
      "type": "award",
      "amount": "50.00",
      "created_at": "2021-04-08T15:38:46.754Z",
      "status": "completed",
      "balance": "1525.00",
      "currency": "NOK",
      "entry": {
        "id": 6616,
        "tickets_count": 5,
        "created_at": "2021-04-08T15:29:48.707Z",
        "entry_type": null,
        "is_revealed": true,
        "drawing": {
          "id": 2106,
          ...
          "headline": "Lottery for testing  purpose",
          "description": "",
          "ends_at": "2021-04-08T15:38:00.000Z",
          "tickets_count": 1000,
          "ticket_price": "25.00",
          "currency": "NOK",
          "cover_url": null,
        ...
        "photo": {
          "id": 2328,
          "url": "https://res.cloudinary.com/dw6cjlb5l/image/upload/v1617895787/llbjfb16dsgndavdu96n.jpg",
          "thumbnail_url": "https://res.cloudinary.com/dw6cjlb5l/image/upload/c_fill,g_face,h_200,w_200/v1617895787/llbjfb16dsgndavdu96n.jpg",
          "is_default": false,
          "is_played": true,
          "is_visible": true
        },
        "tickets": [
          {
            "id": 4820343,
            "serial_number": "55500728-AC46-41E9-9D0B-A48B36B286CD",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
          ...
          {
            "id": 4820342,
            "serial_number": "9AF8A7F9-059B-41EF-A3E5-48F6C9188CED",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
          ...
          {
            "id": 4820341,
            "serial_number": "15A121E9-E440-44CD-A924-88304007B84A",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
          ...
          {
            "id": 4820340,
            "serial_number": "CE48E0F5-454F-49FB-BB2E-B8255479A6EF",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
          ...
          {
            "id": 4820339,
            "serial_number": "F3A5C976-0801-4A82-A266-CBEC5F0BD4B7",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
    ...
    },
    {
      "type": "payment",
      "amount": "-125.00",
      "created_at": "2021-04-08T15:29:48.747Z",
      "status": "completed",
      "balance": "1475.00",
      "currency": "NOK",
      "entry": {
    ...
    },
    {
      "type": "payment",
      "amount": "-150.00",
      "created_at": "2021-04-08T13:42:35.769Z",
      "status": "completed",
      "balance": "1600.00",
      "currency": "NOK",
      "entry": {
        "id": 6590,
        "tickets_count": 6,
        "created_at": "2021-04-08T13:42:35.738Z",
        "entry_type": null,
        "is_revealed": true,
        "drawing": {
          "id": 2103,
          ...
          "headline": "Lottery for testing  purpose",
          "description": "",
          "ends_at": "2021-04-08T14:08:00.000Z",
          "tickets_count": 1000,
          "ticket_price": "25.00",
          "currency": "NOK",
          "cover_url": null,
        ...
        "photo": {
          "id": 2320,
          "url": "https://res.cloudinary.com/dw6cjlb5l/image/upload/v1617889354/tqibggv4hsqzrqoqwxnm.jpg",
          "thumbnail_url": "https://res.cloudinary.com/dw6cjlb5l/image/upload/c_fill,g_face,h_200,w_200/v1617889354/tqibggv4hsqzrqoqwxnm.jpg",
          "is_default": false,
          "is_played": true,
          "is_visible": true
        },
        "tickets": [
          {
            "id": 4817328,
            "serial_number": "AB1CC0DE-3AF9-4C67-BAC7-C1E5F551B989",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
          ...
          {
            "id": 4817327,
            "serial_number": "1791C314-49E8-4E6A-A72D-D04EA1B326C0",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
          ...
          {
            "id": 4817326,
            "serial_number": "33B56666-E3FC-493D-9958-A782C8E8C530",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
          ...
          {
            "id": 4817325,
            "serial_number": "7D2FA8BA-FBE1-44A5-8D51-867316993657",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
          ...
          {
            "id": 4817324,
            "serial_number": "7B29F063-E345-4F6C-916C-B0EACDFEA015",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
          ...
          {
            "id": 4817323,
            "serial_number": "410FEEB4-7990-420D-8B89-3F510F8B35B5",
            "is_revealed": true,
            "is_scratched": true,
            "scratch_state": [
              [
    ...
    },
    {
      "type": "payment",
      "amount": "-125.00",
      "created_at": "2021-04-08T13:09:09.083Z",
      "status": "completed",
      "balance": "1750.00",
      "currency": "NOK",
      "entry": {
    ...
    },
    {
      "type": "award",
      "amount": "1000.00",
      "created_at": "2021-04-08T13:08:27.428Z",
      "status": "completed",
      "balance": "1875.00",
      "currency": "NOK",
      "entry": {
    ...
    },
    {
      "type": "payment",
      "amount": "-125.00",
      "created_at": "2021-04-08T12:52:09.702Z",
      "status": "completed",
      "balance": "875.00",
      "currency": "NOK",
      "entry": {
...
r = requests.post('https://api-stg3.snapchance.no/drawings/{id}/entries', headers = headers)
...
try {
    $response = $client->request('POST','https://api-stg3.snapchance.no/drawings/{id}/entries', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/drawings/{id}/entries");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "https://api-stg3.snapchance.no/drawings/{id}/entries", data)
    req.Header = headers
...
r = requests.post('https://api-stg3.snapchance.no/tickets/{id}/reveal', headers = headers)
...
try {
    $response = $client->request('POST','https://api-stg3.snapchance.no/tickets/{id}/reveal', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/tickets/{id}/reveal");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "https://api-stg3.snapchance.no/tickets/{id}/reveal", data)
    req.Header = headers
...
r = requests.get('https://api-stg3.snapchance.no/entries', headers = headers)
...
try {
    $response = $client->request('GET','https://api-stg3.snapchance.no/entries', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/entries");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "https://api-stg3.snapchance.no/entries", data)
    req.Header = headers
...
This endpoint is use to return the list of player Entries
...
r = requests.get('https://api-stg3.snapchance.no/entries/{id}', headers = headers)
...
try {
    $response = $client->request('GET','https://api-stg3.snapchance.no/entries/{id}', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/entries/{id}");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "https://api-stg3.snapchance.no/entries/{id}", data)
    req.Header = headers
...
r = requests.patch('https://api-stg3.snapchance.no/entries/{id}/tickets/{ticket_id}', headers = headers)
...
try {
    $response = $client->request('PATCH','https://api-stg3.snapchance.no/entries/{id}/tickets/{ticket_id}', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/entries/{id}/tickets/{ticket_id}");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("PATCH");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("PATCH", "https://api-stg3.snapchance.no/entries/{id}/tickets/{ticket_id}", data)
    req.Header = headers
...
r = requests.post('https://api-stg3.snapchance.no/session', headers = headers)
...
try {
    $response = $client->request('POST','https://api-stg3.snapchance.no/session', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/session");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "https://api-stg3.snapchance.no/session", data)
    req.Header = headers
...
r = requests.post('https://api-stg3.snapchance.no/players', headers = headers)
...
try {
    $response = $client->request('POST','https://api-stg3.snapchance.no/players', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/players");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "https://api-stg3.snapchance.no/players", data)
    req.Header = headers
...
This endpoint is the first step in the registration process.  It will create a player. A valid BankID JWT is required to make this API call.  Please refer to the registration flow documentation.
...
r = requests.post('https://api-stg3.snapchance.no/activation', headers = headers)
...
try {
    $response = $client->request('POST','https://api-stg3.snapchance.no/activation', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/activation");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "https://api-stg3.snapchance.no/activation", data)
    req.Header = headers
...
This Endpoint is used to activate a Player. It requires that a player already be created using a valid BankID JWT. Please refer to the registration flow documentation.
...
r = requests.post('https://api-stg3.snapchance.no/callbacks', headers = headers)
...
try {
    $response = $client->request('POST','https://api-stg3.snapchance.no/callbacks', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/callbacks");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "https://api-stg3.snapchance.no/callbacks", data)
    req.Header = headers
...
r = requests.get('https://api-stg3.snapchance.no/drawings/{id}/entries', headers = headers)
...
try {
    $response = $client->request('GET','https://api-stg3.snapchance.no/drawings/{id}/entries', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "https://api-stg3.snapchance.no/drawings/{id}/entries", data)
    req.Header = headers
...
r = requests.get('https://api-stg3.snapchance.no/drawings', headers = headers)
...
try {
    $response = $client->request('GET','https://api-stg3.snapchance.no/drawings', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/drawings");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "https://api-stg3.snapchance.no/drawings", data)
    req.Header = headers
...
This endpoint is used to get Info about all the created drawings.Complete history of all the drawings can be retrieved.
...
r = requests.get('https://api-stg3.snapchance.no/drawings/{id}/tickets', headers = headers)
...
try {
    $response = $client->request('GET','https://api-stg3.snapchance.no/drawings/{id}/tickets', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/drawings/{id}/tickets");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "https://api-stg3.snapchance.no/drawings/{id}/tickets", data)
    req.Header = headers
...
r = requests.patch('https://api-stg3.snapchance.no/password', headers = headers)
...
try {
    $response = $client->request('PATCH','https://api-stg3.snapchance.no/password', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/password");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("PATCH");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("PATCH", "https://api-stg3.snapchance.no/password", data)
    req.Header = headers
...
r = requests.post('https://api-stg3.snapchance.no/password_reset', headers = headers)
...
try {
    $response = $client->request('POST','https://api-stg3.snapchance.no/password_reset', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/password_reset");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "https://api-stg3.snapchance.no/password_reset", data)
    req.Header = headers
...
r = requests.patch('https://api-stg3.snapchance.no/password_reset', headers = headers)
...
try {
    $response = $client->request('PATCH','https://api-stg3.snapchance.no/password_reset', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("PATCH", "https://api-stg3.snapchance.no/password_reset", data)
    req.Header = headers
...
r = requests.post('https://api-stg3.snapchance.no/photos', headers = headers)
...
try {
    $response = $client->request('POST','https://api-stg3.snapchance.no/photos', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/photos");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("POST", "https://api-stg3.snapchance.no/photos", data)
    req.Header = headers
...
r = requests.get('https://api-stg3.snapchance.no/photos', headers = headers)
...
try {
    $response = $client->request('GET','https://api-stg3.snapchance.no/photos', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "https://api-stg3.snapchance.no/photos", data)
    req.Header = headers
...
This endpoint is used to returns the list of photos used by the Player.
...
r = requests.delete('https://api-stg3.snapchance.no/photos/{id}', headers = headers)
...
try {
    $response = $client->request('DELETE','https://api-stg3.snapchance.no/photos/{id}', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("https://api-stg3.snapchance.no/photos/{id}");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("DELETE", "https://api-stg3.snapchance.no/photos/{id}", data)
    req.Header = headers
